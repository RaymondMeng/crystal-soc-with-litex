...
#define CSR_DDRPHY_DLY_SEL_ADDR (CSR_BASE + 0x1800L)
#define CSR_DDRPHY_DLY_SEL_SIZE 1
#define CSR_DDRPHY_RDLY_DQ_RST_ADDR (CSR_BASE + 0x1804L)
#define CSR_DDRPHY_RDLY_DQ_RST_SIZE 1
#define CSR_DDRPHY_RDLY_DQ_INC_ADDR (CSR_BASE + 0x1808L)
#define CSR_DDRPHY_RDLY_DQ_INC_SIZE 1
#define CSR_DDRPHY_RDLY_DQ_BITSLIP_RST_ADDR (CSR_BASE + 0x180cL)
#define CSR_DDRPHY_RDLY_DQ_BITSLIP_RST_SIZE 1
#define CSR_DDRPHY_RDLY_DQ_BITSLIP_ADDR (CSR_BASE + 0x1810L)
#define CSR_DDRPHY_RDLY_DQ_BITSLIP_SIZE 1
#define CSR_DDRPHY_BURSTDET_CLR_ADDR (CSR_BASE + 0x1814L)
#define CSR_DDRPHY_BURSTDET_CLR_SIZE 1
#define CSR_DDRPHY_BURSTDET_SEEN_ADDR (CSR_BASE + 0x1818L)
...
#define CSR_VIDEO_TERMINAL_VTG_BASE (CSR_BASE + 0x4800L)
#define CSR_VIDEO_TERMINAL_VTG_ENABLE_ADDR (CSR_BASE + 0x4800L)
#define CSR_VIDEO_TERMINAL_VTG_ENABLE_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_HRES_ADDR (CSR_BASE + 0x4804L)
#define CSR_VIDEO_TERMINAL_VTG_HRES_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_HSYNC_START_ADDR (CSR_BASE + 0x4808L)
#define CSR_VIDEO_TERMINAL_VTG_HSYNC_START_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_HSYNC_END_ADDR (CSR_BASE + 0x480cL)
#define CSR_VIDEO_TERMINAL_VTG_HSYNC_END_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_HSCAN_ADDR (CSR_BASE + 0x4810L)
#define CSR_VIDEO_TERMINAL_VTG_HSCAN_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_VRES_ADDR (CSR_BASE + 0x4814L)
#define CSR_VIDEO_TERMINAL_VTG_VRES_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_VSYNC_START_ADDR (CSR_BASE + 0x4818L)
#define CSR_VIDEO_TERMINAL_VTG_VSYNC_START_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_VSYNC_END_ADDR (CSR_BASE + 0x481cL)
#define CSR_VIDEO_TERMINAL_VTG_VSYNC_END_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_VSCAN_ADDR (CSR_BASE + 0x4820L)
...
static inline uint64_t sdram_dfii_pi0_wrdata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x3014L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x3018L));
	return r;
}
static inline void sdram_dfii_pi0_wrdata_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x3014L));
...
static inline uint64_t sdram_dfii_pi1_wrdata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x3034L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x3038L));
	return r;
}
static inline void sdram_dfii_pi1_wrdata_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x3034L));
	csr_write_simple(v, (CSR_BASE + 0x3038L));
}
static inline uint64_t sdram_dfii_pi1_rddata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x303cL));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x3040L));
	return r;
}
