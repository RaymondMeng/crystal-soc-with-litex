...
void Vsim::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+39,(vlSymsp->TOP__sim.__PVT__timer_pending_status));
            ...
            tracep->chgBit(oldp+42,(vlSymsp->TOP__sim.__PVT__timer_status_status));
            ...
            tracep->chgBit(oldp+137,(((IData)(vlSymsp->TOP__sim.__PVT__timer_pending_status) 
            ...
            tracep->chgBit(oldp+146,((0U == vlSymsp->TOP__sim.__PVT__timer_value)));
            tracep->chgBit(oldp+147,(vlSymsp->TOP__sim.__PVT__timer_zero_pending));
            tracep->chgBit(oldp+148,(vlSymsp->TOP__sim.__PVT__timer_zero_clear));
            tracep->chgBit(oldp+149,(vlSymsp->TOP__sim.__PVT__timer_zero_trigger_d));
            tracep->chgBit(oldp+150,(vlSymsp->TOP__sim.__PVT__uart_enable_re));
            tracep->chgBit(oldp+151,((1U & (((IData)(vlSymsp->TOP__sim.__PVT__uart_pending_status) 
                                             & (IData)(vlSymsp->TOP__sim.__PVT__uart_enable_storage)) 
                                            | (((IData)(vlSymsp->TOP__sim.__PVT__uart_pending_status) 
                                                & (IData)(vlSymsp->TOP__sim.__PVT__uart_enable_storage)) 
                                               >> 1U)))));
            tracep->chgCData(oldp+152,(vlSymsp->TOP__sim.__PVT__uart_pending_r),2);
            tracep->chgBit(oldp+153,(vlSymsp->TOP__sim.__PVT__uart_pending_re));
            tracep->chgBit(oldp+154,(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_readable));
            tracep->chgBit(oldp+155,(vlSymsp->TOP__sim.__PVT__uart_rx_pending));
            tracep->chgBit(oldp+156,((1U & ((IData)(vlSymsp->TOP__sim.__PVT__uart_enable_storage) 
                                            >> 1U))));
            tracep->chgBit(oldp+157,(vlSymsp->TOP__sim.__PVT__uart_rx_clear));
            tracep->chgCData(oldp+158,(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_consume),4);
            tracep->chgBit(oldp+159,(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_do_read));
            tracep->chgBit(oldp+160,(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_fifo_out_first));
            tracep->chgBit(oldp+161,(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_fifo_out_last));
            tracep->chgCData(oldp+162,(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_fifo_out_payload_data),8);
            tracep->chgCData(oldp+163,(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_level0),5);
            tracep->chgCData(oldp+164,((0x1fU & ((IData)(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_level0) 
                                                 + (IData)(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_readable)))),5);
            tracep->chgCData(oldp+165,(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_produce),4);
            tracep->chgSData(oldp+166,(vlSymsp->TOP__sim.__PVT__storage_1_dat1),10);
            tracep->chgBit(oldp+167,(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_syncfifo_re));
            tracep->chgBit(oldp+168,((0U != (IData)(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_level0))));
        }
    }
}
...
void Vsim::traceChgSub1(void* userp, VerilatedVcd* tracep) {
    Vsim__Syms* __restrict vlSymsp = static_cast<Vsim__Syms*>(userp);
    Vsim* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    vluint32_t* const oldp = tracep->oldp(vlSymsp->__Vm_baseCode + 170);
    if (false && oldp) {}  // Prevent unused
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            tracep->chgCData(oldp+0,(vlSymsp->TOP__sim.__PVT__uart_rx_fifo_wrport_adr),4);
            tracep->chgSData(oldp+1,(vlSymsp->TOP__sim.__PVT__storage_1_dat0),10);
            tracep->chgBit(oldp+2,(vlSymsp->TOP__sim.__PVT__uart_rx_trigger_d));
            tracep->chgBit(oldp+3,(vlSymsp->TOP__sim.__PVT__uart_rxempty_re));
            tracep->chgBit(oldp+4,(vlSymsp->TOP__sim.__PVT__uart_rxfull_re));
            tracep->chgCData(oldp+5,((0xffU & vlSymsp->TOP__sim.__PVT__interface1_dat_w)),8);
            tracep->chgBit(oldp+6,(vlSymsp->TOP__sim.__PVT__uart_rxtx_re));
            tracep->chgBit(oldp+7,(vlSymsp->TOP__sim.__PVT__uart_rxtx_we));
            tracep->chgBit(oldp+8,(vlSymsp->TOP__sim.__PVT__uart_status_re));
            tracep->chgBit(oldp+9,((0x10U != (IData)(vlSymsp->TOP__sim.__PVT__uart_tx_fifo_level0))));
            tracep->chgBit(oldp+10,(vlSymsp->TOP__sim.__PVT__uart_tx_pending));
            tracep->chgBit(oldp+11,((1U & (IData)(vlSymsp->TOP__sim.__PVT__uart_enable_storage))));
            tracep->chgBit(oldp+12,(vlSymsp->TOP__sim.__PVT__uart_tx_clear));
            tracep->chgCData(oldp+13,(vlSymsp->TOP__sim.__PVT__uart_tx_fifo_consume),4);
            tracep->chgCData(oldp+14,(vlSymsp->TOP__sim.__PVT__uart_tx_fifo_level0),5);
            tracep->chgCData(oldp+15,((0x1fU & ((IData)(vlSymsp->TOP__sim.__PVT__uart_tx_fifo_level0) 
                                                + (IData)(vlSymsp->TOP__sim.__PVT__uart_tx_fifo_readable)))),5);
            tracep->chgCData(oldp+16,(vlSymsp->TOP__sim.__PVT__uart_tx_fifo_produce),4);
            tracep->chgSData(oldp+17,(vlSymsp->TOP__sim.__PVT__storage_dat1),10);
            tracep->chgSData(oldp+18,((0xffU & vlSymsp->TOP__sim.__PVT__interface1_dat_w)),10);
            tracep->chgBit(oldp+19,((0U != (IData)(vlSymsp->TOP__sim.__PVT__uart_tx_fifo_level0))));
            tracep->chgCData(oldp+20,(vlSymsp->TOP__sim.__PVT__uart_tx_fifo_wrport_adr),4);
            tracep->chgSData(oldp+21,(vlSymsp->TOP__sim.__PVT__storage_dat0),10);
            tracep->chgBit(oldp+22,(((IData)(vlSymsp->TOP__sim.__PVT__uart_rxtx_re) 
                                     & (0x10U != (IData)(vlSymsp->TOP__sim.__PVT__uart_tx_fifo_level0)))));
            tracep->chgBit(oldp+23,(vlSymsp->TOP__sim.__PVT__uart_tx_trigger_d));
            tracep->chgBit(oldp+24,(vlSymsp->TOP__sim.__PVT__uart_txempty_re));
            tracep->chgBit(oldp+25,(vlSymsp->TOP__sim.__PVT__uart_txfull_re));
            tracep->chgBit(oldp+26,((((IData)(vlSymsp->TOP__sim.__PVT__array_muxed4) 
                                      & (IData)(vlSymsp->TOP__sim.__PVT__array_muxed3)) 
                                     & (~ (IData)(vlSymsp->TOP__sim.__PVT__shared_ack)))));
            tracep->chgSData(oldp+27,(vlSymsp->TOP__sim.__PVT__sram_adr0),11);
            tracep->chgSData(oldp+28,(vlSymsp->TOP__sim.__PVT__main_ram_adr0),14);
            tracep->chgCData(oldp+29,(vlSymsp->TOP__sim.__PVT__mem_adr0),6);
            tracep->chgSData(oldp+30,(vlSymsp->TOP__sim.__PVT__storage[0]),10);
            tracep->chgSData(oldp+31,(vlSymsp->TOP__sim.__PVT__storage[1]),10);
            tracep->chgSData(oldp+32,(vlSymsp->TOP__sim.__PVT__storage[2]),10);
            tracep->chgSData(oldp+33,(vlSymsp->TOP__sim.__PVT__storage[3]),10);
            tracep->chgSData(oldp+34,(vlSymsp->TOP__sim.__PVT__storage[4]),10);
            tracep->chgSData(oldp+35,(vlSymsp->TOP__sim.__PVT__storage[5]),10);
            tracep->chgSData(oldp+36,(vlSymsp->TOP__sim.__PVT__storage[6]),10);
            tracep->chgSData(oldp+37,(vlSymsp->TOP__sim.__PVT__storage[7]),10);
            tracep->chgSData(oldp+38,(vlSymsp->TOP__sim.__PVT__storage[8]),10);
            tracep->chgSData(oldp+39,(vlSymsp->TOP__sim.__PVT__storage[9]),10);
            tracep->chgSData(oldp+40,(vlSymsp->TOP__sim.__PVT__storage[10]),10);
            tracep->chgSData(oldp+41,(vlSymsp->TOP__sim.__PVT__storage[11]),10);
            tracep->chgSData(oldp+42,(vlSymsp->TOP__sim.__PVT__storage[12]),10);
            tracep->chgSData(oldp+43,(vlSymsp->TOP__sim.__PVT__storage[13]),10);
            tracep->chgSData(oldp+44,(vlSymsp->TOP__sim.__PVT__storage[14]),10);
            tracep->chgSData(oldp+45,(vlSymsp->TOP__sim.__PVT__storage[15]),10);
            tracep->chgSData(oldp+46,(vlSymsp->TOP__sim.__PVT__storage_1[0]),10);
            tracep->chgSData(oldp+47,(vlSymsp->TOP__sim.__PVT__storage_1[1]),10);
            tracep->chgSData(oldp+48,(vlSymsp->TOP__sim.__PVT__storage_1[2]),10);
            tracep->chgSData(oldp+49,(vlSymsp->TOP__sim.__PVT__storage_1[3]),10);
            tracep->chgSData(oldp+50,(vlSymsp->TOP__sim.__PVT__storage_1[4]),10);
            tracep->chgSData(oldp+51,(vlSymsp->TOP__sim.__PVT__storage_1[5]),10);
            tracep->chgSData(oldp+52,(vlSymsp->TOP__sim.__PVT__storage_1[6]),10);
            tracep->chgSData(oldp+53,(vlSymsp->TOP__sim.__PVT__storage_1[7]),10);
            tracep->chgSData(oldp+54,(vlSymsp->TOP__sim.__PVT__storage_1[8]),10);
            tracep->chgSData(oldp+55,(vlSymsp->TOP__sim.__PVT__storage_1[9]),10);
            tracep->chgSData(oldp+56,(vlSymsp->TOP__sim.__PVT__storage_1[10]),10);
            tracep->chgSData(oldp+57,(vlSymsp->TOP__sim.__PVT__storage_1[11]),10);
            tracep->chgSData(oldp+58,(vlSymsp->TOP__sim.__PVT__storage_1[12]),10);
            tracep->chgSData(oldp+59,(vlSymsp->TOP__sim.__PVT__storage_1[13]),10);
            tracep->chgSData(oldp+60,(vlSymsp->TOP__sim.__PVT__storage_1[14]),10);
            tracep->chgSData(oldp+61,(vlSymsp->TOP__sim.__PVT__storage_1[15]),10);
            tracep->chgBit(oldp+62,(vlSymsp->TOP__sim.__Vcellinp__VexRiscv__reset));
            tracep->chgBit(oldp+63,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache_io_flush));
            tracep->chgBit(oldp+64,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_fetchPc_output_valid));
            tracep->chgBit(oldp+65,(((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT___zz_IBusCachedPlugin_iBusRsp_stages_1_input_valid_1) 
                                     & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_s1_tightlyCoupledHit)))));
            tracep->chgBit(oldp+66,((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_iBusRsp_stages_2_input_ready)))));
            tracep->chgBit(oldp+67,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache_io_cpu_decode_isValid));
            tracep->chgBit(oldp+68,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache_io_cpu_fill_valid));
            tracep->chgBit(oldp+69,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_execute_isValid));
            tracep->chgIData(oldp+70,(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_SrcPlugin_addSub),32);
            tracep->chgBit(oldp+71,(((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__memory_arbitration_isValid) 
                                     & (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_to_memory_MEMORY_ENABLE))));
            tracep->chgIData(oldp+72,(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_to_memory_REGFILE_WRITE_DATA),32);
            tracep->chgBit(oldp+73,((1U & (vlSymsp->TOP__sim__VexRiscv.__PVT__execute_to_memory_REGFILE_WRITE_DATA 
                                           >> 0x1fU))));
            tracep->chgBit(oldp+74,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_writeBack_isValid));
            tracep->chgIData(oldp+75,(vlSymsp->TOP__sim__VexRiscv.__PVT__memory_to_writeBack_MEMORY_STORE_DATA_RF),32);
            tracep->chgIData(oldp+76,(vlSymsp->TOP__sim__VexRiscv.__PVT__memory_to_writeBack_REGFILE_WRITE_DATA),32);
            tracep->chgBit(oldp+77,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_flush_valid));
            tracep->chgBit(oldp+78,((0U != (0x1fU & 
                                            (vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_INSTRUCTION 
                                             >> 0xfU)))));
            tracep->chgCData(oldp+79,((0x7fU & (vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_RS1 
                                                >> 5U))),7);
            tracep->chgBit(oldp+80,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache_io_cpu_prefetch_haltIt));
            tracep->chgIData(oldp+81,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT___zz_banks_0_port1),32);
            tracep->chgBit(oldp+82,((1U & ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_hit_error) 
            ...
            tracep->chgBit(oldp+83,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_refilling));
            tracep->chgBit(oldp+84,((((~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_refilling)) 
                                      & (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_isPaging)) 
                                     & ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_exception) 
                                        | (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_allowExecute))))));
            tracep->chgIData(oldp+85,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__io_cpu_fetch_data_regNextWhen),32);
            tracep->chgBit(oldp+86,((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_hit_valid)))));
            tracep->chgIData(oldp+87,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_physicalAddress),32);
            tracep->chgBit(oldp+88,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache_io_mem_cmd_valid));
            tracep->chgIData(oldp+89,((0xffffffe0U 
                                       & vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_address)),32);
            tracep->chgBit(oldp+90,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_execute_haltIt));
            tracep->chgBit(oldp+91,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1__DOT__loader_valid));
            tracep->chgBit(oldp+92,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1__DOT__stageA_request_wr));
            tracep->chgBit(oldp+93,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_writeBack_haltIt));
            tracep->chgIData(oldp+94,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_writeBack_data),32);
            tracep->chgBit(oldp+95,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_writeBack_mmuException));
            tracep->chgBit(oldp+96,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_writeBack_unalignedAccess));
            tracep->chgBit(oldp+97,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_writeBack_accessError));
            tracep->chgBit(oldp+98,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1__DOT__stageB_request_wr));
            tracep->chgBit(oldp+99,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_flush_ready));
            tracep->chgBit(oldp+100,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_redo));
            tracep->chgBit(oldp+101,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_mem_cmd_valid));
            tracep->chgBit(oldp+102,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_mem_cmd_payload_wr));
            tracep->chgBit(oldp+103,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1__DOT__stageB_mmuRsp_isIoAccess));
            tracep->chgIData(oldp+104,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_mem_cmd_payload_address),32);
            tracep->chgCData(oldp+105,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1__DOT__stageB_mask),4);
            tracep->chgCData(oldp+106,(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_mem_cmd_payload_size),3);
            tracep->chgQData(oldp+107,((0xfffffffffffffULL 
                                        & (((((QData)((IData)(
                                                              (0x7ffffU 
                                                               & (- (IData)(
                                                                            (1U 
                                           ...
                                           + (((QData)((IData)(
                                              ...
                                              | (0x3ffffffffffffULL 
                                                 & (vlSymsp->TOP__sim__VexRiscv.__PVT__execute_to_memory_MUL_HL 
                                                    << 0x10U)))))),52);
            tracep->chgQData(oldp+109,(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_to_memory_MUL_HH),34);
            ...
            tracep->chgQData(oldp+113,((0x3ffffffffULL 
                                        & VL_MULS_QQQ(34,34,34, 
                                                      (0x3ffffffffULL 
                                                       & VL_EXTENDS_QI(34,17, vlSymsp->TOP__sim__VexRiscv.__PVT__execute_MulPlugin_aHigh)), 
                                                      (0x3ffffffffULL 
            ...
            tracep->chgQData(oldp+115,((0x3ffffffffULL 
                                        & VL_MULS_QQQ(34,34,34, 
                                                      (0x3ffffffffULL 
                                                       & VL_EXTENDS_QI(34,17, 
                                                                       (0xffffU 
                                                      ...
                                                      (0x3ffffffffULL 
                                                       & VL_EXTENDS_QI(34,17, vlSymsp->TOP__sim__VexRiscv.__PVT__execute_MulPlugin_bHigh))))),34);
            tracep->chgIData(oldp+117,(((0xffffU & vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_RS1) 
                                        * (0xffffU 
                                           & vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_RS2))),32);
            tracep->chgIData(oldp+118,((0xfffffffeU 
            ...
            tracep->chgBit(oldp+119,((((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_PREDICTION_HAD_BRANCHED2) 
                                      ...
                                      | ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT___zz_execute_BRANCH_COND_RESULT_1) 
                                         & ((3U == (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_BRANCH_CTRL))
                                             ...
                                             : ((2U 
                                                ...
                                                (vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_INSTRUCTION 
                                                 >> 8U)))))));
            tracep->chgIData(oldp+120,((IData)((0x1ffffffffULL 
            ...
            tracep->chgIData(oldp+121,(((2U == (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_ALU_CTRL))
            ...
            tracep->chgIData(oldp+122,(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_to_memory_MEMORY_STORE_DATA_RF),32);
            tracep->chgIData(oldp+123,(((0U == (3U 
                                                & (vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_INSTRUCTION 
                                                   >> 0xcU)))
                                         ? ((0xff000000U 
                                               ...
                                               | ((3U 
                                                  ...
                                                  & (0U 
                                                     ...
                                                     (0x1fU 
                                                      & (vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__io_cpu_fetch_data_regNextWhen 
                                                         >> 0xfU)))))))));
            tracep->chgBit(oldp+126,(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_decodePrediction_cmd_hadBranch));
...
void Vsim::traceChgSub2(void* userp, VerilatedVcd* tracep) {
    Vsim__Syms* __restrict vlSymsp = static_cast<Vsim__Syms*>(userp);
    Vsim* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    vluint32_t* const oldp = tracep->oldp(vlSymsp->__Vm_baseCode + 300);
    if (false && oldp) {}  // Prevent unused
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
